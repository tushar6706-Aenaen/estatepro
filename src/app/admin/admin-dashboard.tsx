              ...
              >
                ...
                <div className="space-y-4 p-5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className="rounded-full bg-amber-400/15 px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.2em] text-amber-200">
                      Pending
                    </span>
                  </div>
                  ...
                  {decisionError && (
                    <div className="rounded-xl border border-red-300/30 bg-red-500/10 px-3 py-2 text-xs text-red-200">
                      {decisionError}
                    </div>
                  )}
                  ...
                  <div className="flex flex-wrap gap-3 text-xs">
                    <button
                      ...
                      className="rounded-full bg-emerald-500 px-4 py-2 font-semibold text-white transition hover:bg-emerald-400 disabled:opacity-70"
                    >
                      Approve
                    </button>
                    <button
                      ...
                      disabled={decisionBusy}
                      className="rounded-full border border-rose-300/40 bg-rose-500/10 px-4 py-2 font-semibold text-rose-200"
                    >
                      Reject
                    </button>
                  </div>
